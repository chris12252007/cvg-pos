<div class="col-lg-12">
    <div class="metronicView">
        <header>
            <span><i class="minia-icon-search"></i>View - PaymentTypes</span>
            ...
            <?php print CHtml::link('View/Search', $this->createUrl('PaymentTypes/admin'), array('class' => 'btn-back', 'data-tooltip' => 'manage')); ?>
             </header>
        <div class ="row">
