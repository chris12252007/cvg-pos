...
class PaymentTypesController extends SiteadminController
{
/**
...
if($model->validate()) {
$model->save();
Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'New PaymentTypes Successfully Created.');
...
if($model->validate()) {
$model->save();
Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'PaymentTypes Successfully Updated');
$this->redirect(array('view','id'=>$model->id));
} else {
Utilities::set_Flash(Utilities::FLASH_ERROR, Utilities::get_ModelErrors($model->errors));
}
...
{
$dataProvider=new CActiveDataProvider('PaymentTypes');
...
Utilities::setMenuActive_Siteadmin(Settings::get_ControllerID(), 'PaymentTypes::tbl()', Settings::get_ActionID());
...
{
if(isset($_GET['id']))
$this->_model=PaymentTypes::model()->findbyPk($_GET['id']);
if($this->_model===null)
...
{
$this->redirect($this->createUrl('PaymentTypes/create'));
}
}
