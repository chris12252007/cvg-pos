...
class DealersController extends SiteadminController
{
	...
	*/
	...
	if($model->validate()) {
	$model->save();
	Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'New Dealers Successfully Created.');
	...
	*/
	...
	if($model->validate()) {
	$model->save();
	Utilities::set_Flash(Utilities::FLASH_SUCCESS, 'Dealers Successfully Updated');
	$this->redirect(array('view','id'=>$model->id));
	} else {
	Utilities::set_Flash(Utilities::FLASH_ERROR, Utilities::get_ModelErrors($model->errors));
	}
	...
	*/
	...
	Utilities::setMenuActive_Siteadmin(Settings::get_ControllerID(), 'Dealers::tbl()', Settings::get_ActionID());
