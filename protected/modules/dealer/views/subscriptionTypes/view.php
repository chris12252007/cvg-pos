<div class="col-lg-12">
    <div class="metronicView">
        <header>
            <span><i class="minia-icon-search"></i>View - SubscriptionTypes</span>
            ...
            <?php print CHtml::link('View/Search', $this->createUrl('SubscriptionTypes/admin'), array('class' => 'btn-back', 'data-tooltip' => 'manage')); ?>
             </header>
        <div class ="row">
