<header class="main-header">
    <!-- Logo -->
    <a href="http://localhost:8080/elsts/index.php?r=dealer/default/index" class="logo"><b>Ãdmin</b> LTE</a>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?php print Settings::get_baseUrl(); ?>/adminlte/dist/img/user3-128x128.jpg" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?php print Settings::get_baseUrl(); ?>/adminlte/dist/img/user4-128x128.jpg" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="<?php print Settings::get_baseUrl(); ?>/adminlte/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" />
                            <p>
                                <?php print Settings::get_employeeName() ?> - After-Sales Head
