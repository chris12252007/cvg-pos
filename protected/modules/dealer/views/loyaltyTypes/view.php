<div class="col-lg-12">
    <div class="metronicView">
        <header>
            <span><i class="minia-icon-search"></i>View - LoyaltyTypes</span>
            ...
            <?php print CHtml::link('View/Search', $this->createUrl('LoyaltyTypes/admin'), array('class' => 'btn-back', 'data-tooltip' => 'manage')); ?>
             </header>
        <div class ="row">
