<div class="col-lg-12">
    <div class="metronicView">
        <header>
            <span><i class="minia-icon-search"></i>View - ServicesTypes</span>
            ...
            <?php print CHtml::link('View/Search', $this->createUrl('ServicesTypes/admin'), array('class' => 'btn-back', 'data-tooltip' => 'manage')); ?>
             </header>
        <div class ="row">
