    ...
    <div class="widget-body no-padding">
        ...
        <fieldset>
            ...
            <section>
                ...
                <label class="input">
                    <?php echo CHtml::activeDropDownList($model, 'role', CHtml::listData(Roles::model_getAllData_byIsDeleted(Utilities::NO), 'id', 'name'), array('prompt' => 'Choose One', 'id' => 'cboAccountTypeId', 'class' => 'form-control'));
                    ?>
                    <b class="tooltip tooltip-bottom-left">
                        Type of your Account
                    </b> 
