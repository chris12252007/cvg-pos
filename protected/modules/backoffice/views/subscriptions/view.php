<div class="col-lg-12">
    <div class="metronicView">
        <header>
            <span><i class="minia-icon-search"></i>View - Subscriptions</span>
            ...
            <?php print CHtml::link('View/Search', $this->createUrl('Subscriptions/admin'), array('class' => 'btn-back', 'data-tooltip' => 'manage')); ?>
             </header>
        <div class ="row">
           <ul class = "col-lg-6 unstyled">
                        ...
                        <li>
                            <span class='icon12 typ-icon-arrow-right'></span>
                            details:
                            <strong> <?php echo $model->details?></strong>
                        </li> 
