...
class Users extends CActiveRecord {
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('is_active, emp_id', 'numerical', 'integerOnly' => true),
            ...
            array('id, created_at, updated_at, username, email, is_active, last_login, emp_id, role', 'safe', 'on' => 'search'),
...
//            array('repeat_password', 'compare', 'compareAttribute' => 'new_password', 'on' => 'update'),
            ...
            array('new_password, repeat_password', 'required', 'on' => 'updateChangePassword'),
            array('repeat_password', 'compare', 'compareAttribute' => 'new_password', 'on' => 'updateChangePassword'),
        );
    }
